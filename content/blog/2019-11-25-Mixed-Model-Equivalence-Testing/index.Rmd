...
**Important update:** For a simpler approach to equivalence testing in mixed models and other complex designs, see "Isager, P. M., & Fitzgerald, J. (2025, June 25). Three-Sided Testing to Establish Practical Significance: A Tutorial. <https://doi.org/10.31234/osf.io/8y925_v2>" and the associated [`eqtesting`](https://cran.r-project.org/web/packages/eqtesting/index.html) R package and [ShinyTST](https://jack-fitzgerald.shinyapps.io/shinyTST/) application.
:::
