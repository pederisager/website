...
However, a more cautious (or "hard-nosed") scientist would remain unconvinced. Why? Because [correlation does not imply causation](https://pedermisager.org/blog/why_does_correlation_not_equal_causation/). There are many reasons two variables might be correlated that have nothing to do with one causing the other.
